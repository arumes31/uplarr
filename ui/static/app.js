    ...
    const sortFiles = (files, sortKey, sortDir) => {
        ...
        sorted.sort((a, b) => {
            ...
            switch (sortKey) {
                ...
                case 'type': {
                    const extA = a.name.lastIndexOf('.') !== -1 ? a.name.substring(a.name.lastIndexOf('.') + 1).toLowerCase() : '';
                    const extB = b.name.lastIndexOf('.') !== -1 ? b.name.substring(b.name.lastIndexOf('.') + 1).toLowerCase() : '';
