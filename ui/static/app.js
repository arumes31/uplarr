    ...
    const renderLocalFiles = () => {
        ...
        sorted.forEach(file => {
            ...
            cb.addEventListener('click', (e) => {
                // ⚡ Bolt: Use pre-computed data-index instead of querying DOM and indexOf on every click
                // 📊 Impact: O(1) time complexity for normal clicks instead of O(N), preventing UI freezes on large lists
