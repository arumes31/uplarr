...
## 2026-06-08 - Fast String Extraction in Comparators
**Learning:** Using `String.prototype.split('.').pop()` to extract file extensions inside a `sort` comparator function allocates an entire array for every comparison, causing massive CPU cycles and memory garbage.
